...
static void adcInitPins(void)
{
	...
	// Clock
	pio_set_output(ADC_SCLK_PIN_BANK, ADC_SCLK_PIN, LOW, DISABLE, ENABLE);
	
	// PWDN
	pio_set_output(ADC_PWDN_PIN_BANK, ADC_PWDN_PIN, LOW, DISABLE, ENABLE);
	
	// Channel MUX
	pio_set_output(ADC_MUX0_PIN_BANK, ADC_MUX0_PIN, LOW, DISABLE, ENABLE);
	pio_set_output(ADC_MUX1_PIN_BANK, ADC_MUX1_PIN, LOW, DISABLE, ENABLE);

	// Speed
	pio_set_output(ADC_SPEED_PIN_BANK, ADC_SPEED_PIN, LOW, DISABLE, ENABLE);

	// Gain
	pio_set_output(ADC_GAIN0_PIN_BANK, ADC_GAIN0_PIN, LOW, DISABLE, ENABLE);
	pio_set_output(ADC_GAIN1_PIN_BANK, ADC_GAIN1_PIN, LOW, DISABLE, ENABLE);
